...
export default function AddExpenseReport(props) {
                ...
                () => {
                    ...
                    storage
                        ...
                        .then(url => {
                            ...
                            db.collection("ExpensesReports").add({
                                imageUrl: url,
                                Amount: amount,
                                Date: date,
                                Description: desc,
                            ...
                            db.collection('RecentActivities').add({
                                Name: adminName,
                                Action: 'Added an Expense Report',
                                Date: date,
                            }).catch((error) => {
                                console.log(error);
                            });
                ...
                <Box sx={style.UploadContainer}>
                    <Box sx={style.UploadHeader}>
                        ...
                        <Box sx={style.HeaderLeft}>
                            <Typography sx={style.HeaderText}>Add Expense Report</Typography>
                    ...
                    <Box sx={style.UploadContent}>
                        ...
                        <Box sx={style.GLineOne}>
                            <Box sx={style.GSetAllText}>
                                <Typography sx={style.GSetText}>Supplier Name</Typography>
                        ...
                        <Box sx={style.GLineOne}>
                            <Box sx={style.GSetAllText}>
                                <Typography sx={style.GSetText}>Description</Typography>
                                <Typography sx={style.GSetSubtext}>Specify the Expense Report Description.</Typography>
                            </Box>
                            <TextField
                                sx={style.textFields}
                                id='HotelName'
                        ...
                        <Box sx={style.GLineOne}>
                            <Box sx={style.GSetAllText}>
                                ...
                                <Typography sx={style.GSetSubtext}>Specify Total Amount</Typography>
                            </Box>
                            <TextField
                                sx={style.textFields}
                                type='number'
